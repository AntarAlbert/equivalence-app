 ...
 */
final class Version20260430215357 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE equivalence ADD categorie VARCHAR(50) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE equivalence DROP categorie');
    }
}
